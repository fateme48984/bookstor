...
class PublisherController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $publishers = $query->orderBy('porder','ASC')->orderBy('created_at', 'DESC')->paginate(2);
        $users = User::get();
    ...
    public function store(Request $request)
    {
        ...
        try
        {
            ...
            $message = 'انتشارات با موفقیت ایجاد شد';
            $flash = 'flash_success';
    ...
    public function update(Request $request, $id)
    {
        ...
        try
        {
            ...
            //if(is_Array($allPublishers))
            $message = 'انتشارات با موفقیت ویرایش شد';
            $flash = 'flash_success';
