...
class TranslatorController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // dd($query);
        $translators = $query->orderBy('torder','ASC')->orderBy('created_at', 'DESC')->paginate(2);
        $users = User::get();
    ...
    public function update(Request $request, $id)
    {
        ...
        } elseif ($translator['avatar'] == '' || !file_exists(public_path('/images/translators/' . $translator['avatar']))) {
