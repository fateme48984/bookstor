            ...
            <table class="table table-bordered table-striped list-table">
                ...
                @foreach ($authors as $key=>$author)
                    <tr>
                        ...
                        <th scope="row">{{ $k }}</th>
                        <td >{{ $author->name }}</td>
                        <td><img src="{{ asset('public/images/authors/' . $author->avatar) }}" width="100" /></td>
                        ...
                        <td>
                            <div class="row">
                                <div class="col-12" style="margin-bottom: 3px;">
                                    <a href="{{ route('author.edit', $author->id) }}?page={{request()->get('page',1)}}&s_status={{request()->get('s_status')}}&s_user_id={{request()->get('s_user_id')}}&s_name={{request()->get('s_name')}}&s_nationality={{request()->get('s_nationality')}}" class="btn btn-info pull-right">ویرایش</a>
