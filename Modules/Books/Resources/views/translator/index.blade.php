...
@section('content')
    ...
    <div class="col-lg-10 col-lg-offset-1">
        <h5>
            <i class="fa fa-users"></i> لیست مترجم ها
            ...
            <table class="table table-bordered table-striped list-table">
                ...
                @foreach ($translators as $key=>$translator)
                    <tr>
                        ...
                        <td><img src="{{ asset('public/images/translators/' . $translator->avatar) }}" width="100" /></td>
                        ...
                        <td>
                            <div class="row">
                                <div class="col-12" style="margin-bottom: 3px;">
                                    <a href="{{ route('translator.edit', $translator->id) }}?page={{request()->get('page',1)}}&s_status={{request()->get('s_status')}}&s_user_id={{request()->get('s_user_id')}}&s_name={{request()->get('s_name')}}&s_nationality={{request()->get('s_nationality')}}" class="btn btn-info pull-right">ویرایش</a>
